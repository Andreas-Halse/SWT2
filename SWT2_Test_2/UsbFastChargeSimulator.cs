...
namespace SWT2_Test
{
    ...
    [TestFixture]
    public class TestUsbFastChargerSimulator
    {
        // KUN MED FOR TEST COVERAGE, DETTE ER NAESTEN
        // EN 1 TIL 1 KOPI AF HANDOUT_TESTS
        private UsbFastChargerSimulator _uut;
        [SetUp]
        public void Setup()
        {
            _uut = new UsbFastChargerSimulator();
        }
